...
parser.add_argument("--output_path", type=str, default="vllm_results")
...
parser.add_argument("--num_anmwer", type=int, default=16)
...
prompts = [format_prompt(d) for d in test_data]
